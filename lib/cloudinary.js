...
export async function listFolderPreview(folder, limit = 2) {
  // Fetch a small batch of images for preview
  const result = await byFolder({ prefix: folder, max_results: limit });
  return mapImageResources(result.resources);
}